      ...
      select: {
        ...
        empresa: {
          select: {
            ...
            cobranzaCampo: true,
            requiereAprobacionGastos: true,
            requiereAprobacionCompras: true,
            requiereCajaParaEmitir: true,
            catalogoPorSede: true,
            criterioIgvVentas: true,
            ...
            posMantenerBusqueda: true,
            posComprobanteDefault: true,
            posExigirCpeMedioPago: true,
